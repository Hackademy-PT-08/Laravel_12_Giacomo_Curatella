            ...
            @foreach ($pictures as $picture)
                <div class="col-12 col-md-8">
                    <div class="card mb-3 p-1 rounded-3 border-0">
                        <div class="row">
                            @if($picture->image)
                                <div class="col-2 border border-1 userCardImage rounded-3" style="background-image: url('{{ asset('storage/' . $picture->image) }}');">
                                    <!-- <img src="{{ asset('storage/' . $picture->image) }}" alt="" class="img-fluid"> -->
                                </div>
                            @else
                                <div class="col-2 border border-1 userCardImage rounded-3" style="background-image: url('storage/img_placeholder.jpg');">
                            ...
                            <div class="col-2 border border-1 p-3">
                                <p>Euro</p>
                                <p>{{ round($picture->price, 2) }}</p>
                            </div>
                            <div class="col-2 border border-1 p-3 d-flex flex-column justify-content-around">
